...
def rocm_aiter_fused_experts(
    ...
    if (
        ...
        if (
            ...
            or (quant_config.use_mxfp4_w4a8 and a1q_scale is not None)
        ...
        gate_mode = ""
        if quant_config.use_mxfp4_w4a8 and a1q_scale is not None:
...
class AiterExperts(mk.FusedMoEExpertsModular):
    ...
    def expects_unquantized_inputs(self) -> bool:
        # When paired with MoRI, the prepare/finalize may handle activation
    ...
    def is_supported_config(
        ...
        if (
            ...
            and activation_key == kFp8StaticTensorSym
            and not moe_config.use_mori_kernels
        ):
            return False, "W4A8 modular experts require Mori dispatch"
